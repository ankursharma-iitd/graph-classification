...
def main():
    ...
    pickle.dump(act_count, pickle_file)
    pickle.dump(inact_count, pickle_file)
    pickle.dump(tot_count, pickle_file)
    pickle_file.close()
    # print('pickle here\n')
    pickel_out = open('string_to_int_mapping.pickle', 'wb')
    pickle.dump(string_to_int, pickel_out)
    pickle.dump(counter, pickel_out)
    pickel_out.close()
